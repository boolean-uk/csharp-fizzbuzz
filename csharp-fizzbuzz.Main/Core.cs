...
namespace csharp_fizzbuzz.Main
{
    public class Core
    {
        ...
        public String[] fizzbuzz(String[] nums)
        {
            ...
            // TODO: 1. Implement a function that will look through a list of String representation of numbers and change the values of said array based on the rules below
            /*  
